...
class Model : Contract.Model {
    ...
    private val arrayList =
        ...
        private fun pokemonUrl(): String{
            var randomNum = Random().nextInt(20)
            return "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/$randomNum.png"
        }

    //private var imageUrl = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/home/${Random().nextInt(20)}.png"
    ...
    override fun getNextCourse(onFinishedListener: Contract.Model.OnFinishedListener?) {
        Handler().postDelayed({ onFinishedListener!!.onFinished(getRandomString, pokemonUrl()) }, 1200)
